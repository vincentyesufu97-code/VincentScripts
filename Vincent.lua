-- VINCENT HUB LEGIT (GUI RIDOTTA + FEATURES COMPATTI)
...
--------------------------------------------------------------------
-- FEATURES ORDINATI (ENTRANO NEL QUADRATO)
--------------------------------------------------------------------
local speedBox, speedToggle = makeInputToggle("Speed", 10)
local jumpBox, jumpToggle = makeInputToggle("Jump", 50)
local noclipBox, noclipToggle = makeInputToggle("Noclip", 90)
local espBox, espToggle = makeInputToggle("ESP", 130)
local afkBox, afkToggle = makeInputToggle("Anti-AFK", 170)
